...
public final class MyEshop_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                document.f.action = \"../../cart/process?id\" + id;\n");
      out.write("                document.f.submit();\n");
      out.write("            }\n");
      out.write("        </script>\n");
      out.write("        <p><img src=\"../../web/images/giohang.png\"></p>\n");
      out.write("        <h1>The list of products</h1>\n");
      out.write("        <form name=\"f\" action=\"\" method=\"post\">\n");
      out.write("            Enter item number want to buy :\n");
      ...
      out.write("</td>\n");
      out.write("                    <td><button onclick=\"buy(");
      out.print(elem.getId());
